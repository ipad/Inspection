...
import com.inspetion.Application;
...
public abstract class SerialPortActivity extends Activity {
		...
		public void run() {
			...
			while(!isInterrupted()) {
				...
				try {
					...
					if (size > 0) {
						SLog.printToFile("Received:"+new String(buffer, 0, size));
						Log.i(TAG, new String(buffer, 0, size));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Log.i(TAG, "InvalidParameterException");
		}
	}
